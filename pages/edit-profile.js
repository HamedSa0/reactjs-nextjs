    ...
    return (
      <div className={classes.root}>
          ...
          <form onSubmit={this.handleSubmit} className={classes.form}>
            ...
            <label htmlFor="avatar" className={classes.uploadButton}>
              <Button variant="contained" color="secondary" component="span">
                بارگذاری تصویر <CloudUpload className={classes.icon2} />
              </Button>
            </label>
            ...
            <FormControl margin="normal" fullWidth>
              <InputLabel htmlFor="about">درباره من</InputLabel>
              <Input
                type="text"
                name="about"
                value={about}
        ...
        <Dialog open={openSuccess} disableBackdropClick={true}>
          ...
          <DialogContent>
            <DialogContentText>
              کاربر {updatedUser && updatedUser.name} با موفقیت بروز شد
            </DialogContentText>
          </DialogContent>
        </Dialog>
      </div>
